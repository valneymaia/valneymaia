...
<p>
  Bacharel em Ciência da Computação pela UFCA (2026) com experiência prática em desenvolvimento web/mobile,
  infraestrutura de redes e sistemas embarcados. Atuei 2,5 anos na DTI/UFCA gerenciando redes corporativas,
  automatizando laboratórios e criando dashboards. Transformo problemas operacionais em soluções práticas e escaláveis.
</p>

<p>
  <a href="https://valneymaia.github.io/Portfolio/" target="_blank">
    <img src="https://img.shields.io/badge/Portfólio-valneymaia.dev-0a66c2?style=for-the-badge&logo=firefox&logoColor=white" height="30"/>
  </a>
  &nbsp;
  <a href="https://www.linkedin.com/in/valney-maia-98b5a5150" target="_blank">
    <img src="https://img.shields.io/badge/LinkedIn-Valney_Maia-0a66c2?style=for-the-badge&logo=linkedin&logoColor=white" height="30"/>
  </a>
  &nbsp;
  <a href="mailto:valney.maia.dev@gmail.com">
    <img src="https://img.shields.io/badge/Email-valney.maia.dev%40gmail.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white" height="30"/>
  </a>
  &nbsp;
  <a href="https://instagram.com/valneymaia" target="_blank">
    <img src="https://img.shields.io/badge/Instagram-@valneymaia-E4405F?style=for-the-badge&logo=instagram&logoColor=white" height="30"/>
  </a>
</p>
...
### 🖥️ Bolsista PAP — DTI/UFCA `Jun 2023 – Dez 2025`

- Automatizei a clonagem e padronização de **+300 máquinas em 10 laboratórios** com FOG Project, reduzindo retrabalho e tempo de preparação dos ambientes
- Administrei switches Aruba, APs Ruckus e VLANs/VPNs via HPE IMC, garantindo disponibilidade da rede do câmpus
- Criei dashboards no **Looker Studio** para controle patrimonial e inventário de TI
- Documentei ativos de rede no NetBox e orientei estagiários em atividades técnicas de campo

### 🤖 Voluntário — Pensamento Computacional, UFCA `Jan – Dez 2024`

- Ministrei aulas de **lógica de programação e Arduino** para estudantes de escolas públicas
- Desenvolvi atividades práticas com foco em criatividade, raciocínio lógico e pensamento computacional
...
**Bacharel em Ciência da Computação** — UFCA · 2021–2026

| Certificação | Instituição | Carga |
|---|---|---|
| Capacitação em Sistemas Embarcados | EmbarcaTech | 160h |
| Cloud Services com Swift — Serviços Cognitivos | Eldorado / HackTruck | 100h |
| Algoritmos e POO em Swift | Eldorado / HackTruck | 50h |
| Plataformas de Sensoriamento Inteligente | Virtus | 20h |

---

## 🌍 Idiomas

🇧🇷 **Português** — Nativo &nbsp;|&nbsp; 🇺🇸 **Inglês** — Intermediário (leitura/escrita técnica), básico (conversação)
